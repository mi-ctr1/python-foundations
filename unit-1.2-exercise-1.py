...
userNumber = enteredNumber * 2 # this is a new line
print(">> userNumber at this step = " + str(userNumber)) # this is a new line
answer = input("Ready for the next step? ")
print("Now, add...let's see...")
print(numberToAdd)
userNumber = userNumber + numberToAdd # this is a new line
print(">> userNumber at this step = " + str(userNumber)) # this is a new line
answer = input("Ready for the next step? ")
print("Now, divide the number have by 2.")
answer = input("Ready for the next step? ")
userNumber = userNumber / 2 # this is a new line
print(">> userNumber at this step = " + str(userNumber)) # this is a new line
...
userNumber = userNumber - enteredNumber # this is a new line
print(">> userNumber at this step = " + str(userNumber)) # this is a new line